...
void initPSG( const void *psginit ) {}
void PlaySample( const void *sample ) {}

#else

void initPSG( const void *psginit ) __naked __z88dk_fastcall {
...
void PlaySample( const void *sample ) __naked __z88dk_fastcall {
